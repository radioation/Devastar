...
const int STUNNER_PIN_6 = 9;  // TL is the light gun trigger
const int STUNNER_PIN_5 = 10  // TR is the light gun start
...
void setup() {
  ...
  pinMode(STUNNER_PIN_5, OUTPUT);
  pinMode(STUNNER_PIN_6, OUTPUT); 
  digitalWrite(STUNNER_PIN_4, HIGH);
  digitalWrite(STUNNER_PIN_5, HIGH);
  digitalWrite(STUNNER_PIN_6, HIGH);
...
void loop() { 
  ...
  digitalWrite(STUNNER_PIN_6, HIGH); 
  delay(500);
  digitalWrite(STUNNER_PIN_6, LOW); 
  delay(500);
  digitalWrite(STUNNER_PIN_6, LOW); 
}
